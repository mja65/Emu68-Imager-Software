...
ParallelDownloads = [$($Script:GUIActions.RunParallel)]
Operation Mode = [$($Script:GUICurrentStatus.OperationMode)]
RunMode = [$($Script:GUICurrentStatus.RunMode)]
Delete Existing Files = [$($Script:GUICurrentStatus.DeleteFiles)]
...
CustomScreenMode Width = [$($Script:GUIActions.CustomScreenMode_Width)]
CustomScreenMode Height = [$($Script:GUIActions.CustomScreenMode_Height)]l
CustomScreenMode Framerate = [$($Script:GUIActions.CustomScreenMode_Framerate)]
CustomScreenMode Aspect Ratio = [$($Script:GUIActions.CustomScreenMode_Aspect)]
CustomScreenMode Margins = [$($Script:GUIActions.CustomScreenMode_Margins)]
CustomScreenMode Interlace = [$($Script:GUIActions.CustomScreenMode_Interlace)]
CustomScreenMode Blanking = [$($Script:GUIActions.CustomScreenMode_RB)]
...
Unicam Phase = [$($Script:GUIActions.UnicamPhase)]
Unicam Aspect Ratio = [$($Script:GUIActions.UnicamAspectRatio)]
Unicam ScanLinesNonLaced = [$($Script:GUIActions.UnicamScanLinesNonLaced)]
Unicam ScanLinesLaced = [$($Script:GUIActions.UnicamScanLinesLaced)]
Unicam Size X = [$($Script:GUIActions.UnicamSizeX)]
Unicam Size Y  = [$($Script:GUIActions.UnicamSizeY)]
Unicam Offset X = [$($Script:GUIActions.UnicamOffsetX)]
Unicam Offset Y = [$($Script:GUIActions.UnicamOffsetY)]
Enable Bup Test = [$($Script:GUIActions.EnableBupTest)]
SCSI Device Disabled = [$($Script:GUIActions.SCSIDeviceDisabled)]
DMA Enabled = [$($Script:GUIActions.DMAEnabled)]
IRQ Enabled  = [$($Script:GUIActions.IRQEnabled)]
AgnusType = [$($Script:GUIActions.AgnusType)]
SD LowSpeed = [$($Script:GUIActions.SDLowSpeed)]
SD OverClock = [$($Script:GUIActions.SDOverClock)]
SD OverClockSpeed = [$($Script:GUIActions.SDOverClockSpeed)] 
Enable USB Stack = [$($Script:GUIActions.EnableUSBStack)]
Poseidon Version = [$($Script:GUIActions.PoseidonVersion)]
MUI Version = [$($Script:GUIActions.MUIVersion)]
Network Stack = [$($Script:GUIActions.NetworkStack)]
