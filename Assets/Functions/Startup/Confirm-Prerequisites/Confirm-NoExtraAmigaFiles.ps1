...
$ListofFiles = @"
    ...
    \System\PiStorm\Network\OfflineScriptMenutools_AmiTCP_NG
    ...
    \System\PiStorm\Network\OnlineGENetScriptMenutools_AmiTCP_NG
    ...
    \System\PiStorm\Network\OnlineWifiScriptMenuTools_AmiTCP_NG
