function Get-SettingsDataforSave {
    ...
    $Output += "Setting;DeleteAllDownloadedFiles;$($Script:GUIActions.DeleteAllDownloadedFiles)"
    $Output += "Setting;RunParallel;$($Script:GUIActions.RunParallel)"
    ...
    $Output += "Setting;Emu68VersionType;$($Script:GUIActions.Emu68VersionType)"
    ...
    $Output += "Setting;MUIVersion;$($Script:GUIActions.MUIVersion)" 
    ...
    $Output += "Setting;EnableBupTest;$($Script:GUIActions.EnableBupTest)"
    $Output += "Setting;SCSIDeviceDisabled;$($Script:GUIActions.SCSIDeviceDisabled)"
    $Output += "Setting;DMAEnabled;$($Script:GUIActions.DMAEnabled)"
    $Output += "Setting;IRQEnabled;$($Script:GUIActions.IRQEnabled)"
    $Output += "Setting;AgnusType;$($Script:GUIActions.AgnusType)"
    $Output += "Setting;SDLowSpeed;$($Script:GUIActions.SDLowSpeed)"
    $Output += "Setting;SDOverClock;$($Script:GUIActions.SDOverClock)"
    $Output += "Setting;SDOverClockSpeed;$($Script:GUIActions.SDOverClockSpeed)"
    $Output += "Setting;EnableUSBStack;$($Script:GUIActions.EnableUSBStack)"
    $Output += "Setting;PoseidonVersion;$($Script:GUIActions.PoseidonVersion)"
    ...
    $Output += "Setting;UnicamPhase;$($Script:GUIActions.UnicamPhase)"
    $Output += "Setting;UnicamAspectRatio;$($Script:GUIActions.UnicamAspectRatio)"
    $Output += "Setting;UnicamScanLinesNonLaced;$($Script:GUIActions.UnicamScanLinesNonLaced)"
    $Output += "Setting;UnicamScanLinesLaced;$($Script:GUIActions.UnicamScanLinesLaced)"
    $Output += "Setting;UnicamSizeX;$($Script:GUIActions.UnicamSizeX)"
    $Output += "Setting;UnicamSizeY;$($Script:GUIActions.UnicamSizeY)"
    $Output += "Setting;UnicamOffsetX;$($Script:GUIActions.UnicamOffsetX)"
    $Output += "Setting;UnicamOffsetY;$($Script:GUIActions.UnicamOffsetY)"
